...
struct Self<U16> {
	...
	FI10_6 convert(FU32 r_ohm) const {
		FI16 logR = Math::Fp::log2fix(U16(((FU32(r_ohm) << 12) /* 20.12 */ / m_rIce_ohm /* 16.0 */) /* 20.12 */) /* 4.12 */, 16 - 4) /* 4.12 */;
		BGA__MCU__SENSOR__ANALOG__NTC_THERMISTOR__DEBUG_INPECT(logR);
		FI32 oneDivAbsTemp = FI32(((FI32(m_oneDivB /* -9.25 */) * logR /* 4.12 */) /* -5.37 */ >> 14) /* -7.23 */ + FI32(I16(1.0 / 273.15 * (uintmax_t(1) << 23))));
